...
<div  class="col-md-7" style="background-color:lightgrey;color:blue" >
 ...
 <div  class="" style="margin-top:3rem;paddig-left:2rem;margin-left:4rem;width:500px">
    <h2 class="" style="border-bottom: 5px solid #cc3277">Teacher Details</h2>
    <p style="color: white"><span style="font-size:1.3rem;color:#9932cc">Name: </span> {{ $teachers->full_name }}</p>
    <p style="color: white"><span style="font-size:1.3rem;color:darkorchid">Gender: </span> {{ $teachers->gender }}</p>
    <p style="color: white"><span style="font-size:1.3rem;color:darkorchid">Institution: </span> {{ $teachers->institution }}</p>
    <p style="color: white"><span style="font-size:1.3rem;color:darkorchid">Subject: </span> {{ $teachers->subject }}</p>
    <p style="color: white"><span style="font-size:1.3rem;color:darkorchid"> District: </span> {{ $teachers->district }}</p>

 </div>

 <h2 class="" style="border-bottom: 5px solid #cc3277;width:500px;margin-left:4rem;margin-top:3rem">Teacher Requirements</h2>
 <div  class="" style="margin-top:1rem;paddig-left:2rem;margin-left:4rem;width:500px">
 <p style="color: white"><span style="font-size:1.3rem;color:#9932cc">Available Tuition Schedule : </span> {{ $teachers->schedule}}</p>
 <p style="color: white"><span style="font-size:1.3rem;color:darkorchid">Expected Students Level: </span> {{ $teachers->student_level }}</p>
 <p style="color: white"><span style="font-size:1.3rem;color:darkorchid">Prefered Subject: </span> {{ $teachers->prefered_subject }}</p>
 <p style="color: white"><span style="font-size:1.3rem;color:darkorchid">Expected Salary: </span> {{ $teachers->salary }}</p>
 </div>
