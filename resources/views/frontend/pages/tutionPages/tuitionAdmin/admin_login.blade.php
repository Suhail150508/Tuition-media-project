...
<div  class="row" style="background-color:lightseagreen;text-align:center;padding:3rem">
 ...
 <div  class="col-md-8 " style="font-size:2.5rem ;border-radius:15px;background-color:ghostwhite;color:black">
    <h2 class="col-md-9" style="margin-top:3rem;margin-bottom:2rem">Login here </h2>
           ...
           @csrf
            <div class="form-row "  >
              ...
              <div class="form-group col-md-9" >
                ...
                <button type="submit" class=" button btn-success col-md-5 py-2 form-group form-control" style="width: 5rem;height:4rem" >Log in</button>
              </form>
