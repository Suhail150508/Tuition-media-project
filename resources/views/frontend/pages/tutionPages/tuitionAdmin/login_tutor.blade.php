...
<div  class="row" style="background-color:lightseagreen;text-align:center;padding:3rem">
 ...
 <div  class="col-md-6 " style="font-size:2.5rem ;border-radius:15px;background-color:ghostwhite;color:black">
    <h2 class="col-md-9" style="margin-top:3rem;">Login here </h2>
    <div style="margin:1.5rem;text-align:center;background-color:darkseagreen">
        <form action="{{ url('/login-store-tutor') }}" method="POST" style="padding-top:3rem;padding-left:2rem;">
           @csrf
            <div class="form-row">
            ...
            <div class=" d-flex">
                <button type="submit" class=" default-btn btn col-md-5 py-2 form-group form-control" style="width:100%;height:4rem;border-radius:50px" >Log in</button>
                @if (Route::has('password.request'))
                    <a class="btn btn-link col-md-10" style="padding-bottom:2rem;font-size:1.4rem" href="{{ route('password.request') }}">
